...
@Route(value = "operario",layout=MainView.class)
public class OperarioView extends VerticalLayout {

    public OperarioView() throws Exception {
        API api = new API();
        ...
        inventarioBtn.addClickListener(e -> UI.getCurrent().navigate("inventariolite"));
        ...
        topMenu.add(
                new RouterLink(inventarioBtn.getText(), inventarioviewoperario.class),
